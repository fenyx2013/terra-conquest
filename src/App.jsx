...
const SHOP_ITEMS=[
  {id:"tank",      label:"\u{1FA96} Tank",      desc:"Basic ground unit. Cheap & reliable.",        price:1800,  dmg:DMG.tank,      color:"#f59e0b"},
  {id:"bomb",      label:"\u{1F4A3} Bomb",      desc:"Explosive. High damage.",                     price:3000,  dmg:DMG.bomb,      color:"#ef4444"},
  {id:"plane",     label:"✈️ Plane",     desc:"Air unit. Extends attack radius to 3.",       price:4700,  dmg:DMG.plane,     color:"#3b82f6"},
  {id:"missile",   label:"🚀 Missile",   desc:"Ballistic strike. Very high damage.",         price:6750,  dmg:DMG.missile,   color:"#f97316"},
  {id:"artillery", label:"🛦🔥 Artillery", desc:"Heavy cannon. 2 dmg, area suppression.",     price:5000,  dmg:DMG.artillery, color:"#a78bfa"},
  {id:"drone",     label:"🛰Drone",     desc:"Precision strike. 4 dmg, hard to intercept.",price:10000,  dmg:DMG.drone,     color:"#06b6d4", oilCost:1},
  {id:"bomber",    label:"🛦💣 Bomber",    desc:"Carpet bomb. 5 dmg",                price:18000, dmg:DMG.bomber,    color:"#dc2626", oilCost:1},
  {id:"air_def",      label:"🛡️✈️ Air Def",      desc:"Reduces enemy win chance by 5% each.",               price:12000,   dmg:0,               color:"#6366f1", oilCost:2},
  {id:"chem_bomb",    label:"💣☣️ Chem Bomb",    desc:"6 dmg + poisons country: next attacker -20% win.",  price:26000,  dmg:DMG.chem_bomb,   color:"#84cc16", oilCost:3},
  {id:"emp",          label:"⚡📡 EMP",          desc:"0 dmg but disables all enemy buildings for 4 min.",  price:10500,  dmg:0,               color:"#f0abfc", oilCost:2},
  {id:"mortar",          label:"🌀🌫️💣 Fading Reboot Mortar",          desc:"7 dmg, a remineder of what war causes",  price:32000,  dmg:DMG.mortar,               color:"#565051", oilCost:2},
  {id: "droner_ghoster", label:"🛰🔍❌ L.O.S.T Drone", desc:"8.5 dmg. Updated with Droney systems!",              price: 42500,  dmg:DMG.droner_ghoster, color:"#A020F0", oilCost:2},
  {id: "hell_rainer", label:"💣🌧 H.E.L.L R.A.I.N.😈🔥 ‍‍‍‍‍‍‍‍‍‍ㅤㅤㅤㅤㅤㅤㅤㅤBOMBER", desc:"17.5 dmg. THE DEFINITION OF HELL",              price: 52500,  dmg:DMG.hell_rainer, color:"#880808", oilCost:5},
  {id:"stealth_bomber",label:"🖤🛦💣 B-2 Stealth Bomber",desc:"26.5 dmg. Bypasses Air Defence completely.",           price:129500,  dmg:DMG.stealth_bomber, color:"#c084fc", oilCost:7},
  {id:"orbital_hi",label:"🛰️⚡💥Orbital Railgun",desc:"75 dmg. MAX POWER CONQUER 100% CHANCE OF WINNING!!!!.",           price:799500,  dmg:DMG.orbital_hi, color:"#0096FF", oilCost:17}];
...
const BUILDINGS=[
  {id:"barracks",    label:"🏯 Barracks",    desc:"Discounts Tanks by 20% per barracks.",    max:3, cost:{wood:10,stone:8},      color:"#f59e0b"},
  {id:"airbase",     label:"🏢✈️ Air Base",    desc:"Discounts Planes by 15% per airbase.",    max:2, cost:{stone:10,iron:6},      color:"#3b82f6"},
  {id:"coin_factory",label:"🏭\u{1FA99} Coin Factory",desc:"Earns "+COIN_FACTORY_YIELD+" coins/sec.", max:15, cost:{iron:5,stone:3},      color:"#10b981"},
  {id:"vault",       label:"🏦 Gold Vault",  desc:"+500 daily reward. +2 coins/sec/factory.",max:3, cost:{gold:6,iron:8},       color:"#f59e0b"},
  {id:"oil_rig",       label:"⛽🛢️ Oil Rig",       desc:"Generates +1 Oil every 2 minutes.",                     max:2, cost:{iron:6,stone:4,gold:2},   color:"#78350f"},
  {id:"spy_academy", label:"🕵️🏫 Spy Academy", desc:"Trains 1 spy every 20 min.",              max:1, cost:{wood:18,gold:6},       color:"#10b981"},
  {id:"watchtower",  label:"🗼 Watchtower",  desc:"Unlocks the Satellite recipe in Weapons Lab. Also lets you see attacker weapon counts.", max:1, cost:{iron:14 ,stone:10},      color:"#6366f1"},
  {id:"embassy",     label:"🏤 Embassy",     desc:"+5% win chance when attacking.",          max:1, cost:{gold:8,stone:14},      color:"#f97316"},
  {id:"port",        label:"⚓ Port",        desc:"+1 attack range (coastal countries only).",max:1, cost:{wood:28,iron:6},      color:"#06b6d4"},
  {id:"mine",        label:"⛏️ Mine",        desc:"+1 Iron & Stone per bonus tick.",          max:2, cost:{wood:44,stone:26},     color:"#78716c"},
  {id:"uranium_ext", label:"☢️ Uranium Extractor",desc:"Converts 1 Gold into 1 Uranium/min.",max:1, cost:{iron:14,stone:10},    color:"#4ade80"},
  {id:"nuclear_reactor",label:"🏭☢️ Nuclear Reactor",desc:"Boosts ALL weapon damage by 50%.", max:1, cost:{iron:14,uranium:7,stone:22}, color:"#a78bfa"},
  {id:"fortress",    label:"🛕 Fortress",    desc:"Fortifies all your territories. Reduces enemy win chance by 10%.", max:1, cost:{stone:22,iron:18},  color:"#f43f5e"},
  {id:"black_market",  label:"🛒🏴‍☠️ Black Market",  desc:"Unlocks the Black Market for rare deals.",              max:1, cost:{gold:12,iron:10},           color:"#8b5cf6"},
  {id:"radar",         label:"📡🏢 Radar Station", desc:"Reveals weapon counts of incoming attackers.",           max:1, cost:{iron:14,gold:6},           color:"#06b6d4"},
  {id:"bomber_factory",         label:"🏭🛦💣 Bomber Factory", desc:"Creates one bomber/2 min",           max:2, cost:{iron:22,gold:14},           color:"#8B0000"},
  ...
  {id:"droneys_factory", label:"🤖🏭 Droneys Factory", desc:"Unlocks the DRONEYSS button. Click 1000 times to earn 10 Drones!", max:1, cost:{iron:7,stone:3,oil:5}, color:"#00bcd4"}];

// Black market pool - 3 random items shown per session
const BLACK_MARKET_POOL=[
  {id:"bm_drone3",  label:"3 Drones",        desc:"Rare precision weapons",                  cost:{coins:15000,gold:1}, reward:{drone:3}},
  {id:"bm_uranium3",label:"3 Uranium",       desc:"Rare radioactive material",               cost:{coins:20000},        reward:{uranium:3}},
  {id:"bm_gold2",   label:"2 Gold Bars",     desc:"Precious metal, hard to find",            cost:{coins:18000,iron:3}, reward:{gold:2}},
  {id:"bm_spy3",    label:"3 Spies",         desc:"Trained operatives, ready to deploy",     cost:{coins:25000},        reward:{spy:3}},
  {id:"bm_missile5",label:"5 Missiles",      desc:"Bulk missile shipment",                   cost:{coins:12000,iron:2}, reward:{missile:5}},
  {id:"bm_stealth", label:"Stealth Kit",     desc:"Next attack: +15% win chance bonus",      cost:{coins:20000,gold:1}, reward:{stealth_kit:1}},
  {id:"bm_shield",  label:"Attack Shield",   desc:"Blocks the next enemy attack on you",     cost:{coins:35000,iron:4}, reward:{shield:1}},
  {id:"bm_bomber2", label:"2 Bombers",       desc:"Devastating carpet bombers",              cost:{coins:20000,iron:3}, reward:{bomber:2}},
  {id:"bm_xp500",   label:"XP Boost",        desc:"Instantly gain 500 Terra Pass XP",       cost:{coins:40000},        reward:{xp:500}},
  {id:"bm_artillery3",  label:"3 Artillery",    desc:"Heavy cannon units",                    cost:{coins:10000,iron:2},      reward:{artillery:3}},
  {id:"bm_oil5",        label:"5 Oil Barrels",  desc:"Smuggled crude oil",                    cost:{coins:15000,gold:1},      reward:{oil:5}},
  {id:"bm_chem2",       label:"2 Chem Bombs",   desc:"Illegal chemical weapons",              cost:{coins:25000,oil:3},       reward:{chem_bomb:2}},
  {id:"bm_emp1",        label:"EMP Device",     desc:"Single-use electromagnetic pulse",      cost:{coins:20000,iron:3},      reward:{emp:1}},
  {id:"bm_ghost1",      label:"Stealth Bomber",   desc:"Stealth aircraft, bypasses air def",    cost:{coins:350000,gold:7},      reward:{stealth_bomber:3}},
  {id:"bm_intel2",      label:"2 Intel Kits",   desc:"Spy on 2 enemies instantly",            cost:{coins:18000},             reward:{spy:2}}];

const WORLD_WONDERS=[
  {id:"event3",    name:"EVENT: UNITED STATES OF EVERYTHING!",     country:"usa",          bonus:{stealth_bomber:5, oil:10, coins:150, label:"UNITED STATES OF EARTH"},   cost:{coins:1000000},        color:"red", desc:"Event changes each month!", event:true},
  {id:"pentagon",    name:"The Pentagon",     country:"usa",          bonus:{coins:80, stealth_bomber:1,  label:"+80 coins/sec & 1 Stealth Bomber/day"},   cost:{coins:1370000,iron:35,gold:65},        color:"#3b82f6", desc:"Dominates North America. Massive coin income for its owner."},
  {id:"ben",    name:"The Big Ben",     country:"uk",          bonus:{coins:100,  label:"+100 coins/sec"},   cost:{coins:500000,iron:8,gold:5},        color:"#D4AF37", desc:"The Tower that ticks gold"},
  {id:"kremlin",     name:"The Kremlin",      country:"russia",       bonus:{troops:5,  label:"+5 tanks/min"},    cost:{coins:130000,stone:10,iron:6},      color:"#ef4444", desc:"Controls Eastern Europe & Asia. Your army grows extremely fast."},
  ...
  {id:"greatwall",   name:"Great Wall",       country:"china",        bonus:{troops:3,  label:"+3 tanks/min"},    cost:{coins:360000,stone:12,iron:4},      color:"#f59e0b", desc:"The mightiest fortification ever built. Troops pour in constantly."},
  {id:"pyramids",    name:"The Pyramids",     country:"egypt",        bonus:{gold:3,    label:"+3 gold/min"},     cost:{coins:320000,stone:8,gold:3},       color:"#f5c842", desc:"Controls North Africa. Gold income is unmatched."},
  {id:"eiffel",      name:"Eiffel Tower",     country:"france",       bonus:{coins:40,  label:"+40 coins/sec"},   cost:{coins:330000,iron:6,gold:4},        color:"#a78bfa", desc:"The most visited landmark on Earth. Coins flow like tourists."},
  {id:"amazon_hq",   name:"Amazon Rainforest",country:"brazil",       bonus:{wood:5,    label:"+5 wood/min"},     cost:{coins:310000,wood:8,stone:4},        color:"#22c55e", desc:"Controls South America. Endless resources from the jungle."},
  {id:"cuba_statue",   name:"The Christ of Havana",country:"cuba",       bonus:{gold: 3, stone:2,    label:"+3 Gold/min & +2 Stone/min"},     cost:{coins:340000,gold:3,stone:11},        color:"#FFFFFF", desc:"Controls Cuba. Endless resources from God"},
  {id:"tokyo_tower",   name:"Tokyo Tower",country:"japan",       bonus:{iron: 5, coins:45,    label:"+5 Iron/min & +45 coins/sec"},     cost:{coins:355000,iron:15,gold:5},        color:"#FFB347", desc:"Controls Japan. Endless resources and coins from the Japan territory."},
  {id:"sydney   ",   name:"Sydney Opera House",country:"australia",       bonus:{coins:65,    label:"+65 coins/sec"},     cost:{coins:357500,iron:11,gold:5},        color:"#707372", desc:"Controls Australia. Endless coins from the Austalian territory."},
  {id:"mt_olymp",   name:"Mount Olympus",country:"greece",       bonus:{stone:20, wood:10,    label:"+20 stone/min & +10 wood/min "},     cost:{coins:370000,stone:33,gold:5},        color:"#636363", desc:"The home of Gods."},
  {id:"dracula",     name:"Dracula's Castle",  country:"romania",      bonus:{spy:3,     label:"+3 spies/day & -15% def"},cost:{coins:500000,stone:6,gold:5}, color:"#dc2626", desc:"Built on cursed ground — enemies fear it. Spy production surges and all attackers suffer -15% win chance against your territories.", special:true},
  {id:"gates_of_hell",     name:"Gates of Hell",  country:"turkmenistan",      bonus:{coins:-66666666666666666666666666666666666, devils1:666,    label:"REMOVES ALL YOUR COINS! & +666 devil tanks/min"},cost:{coins:6666666,stone:666,gold:666}, color:"#FF6A00", desc:"Devils bargain, Lose your wealth forever but get the devils troops", special:true},
  {id:"nuclear_disaster",     name:"Cernobyl",  country:"ukraine",      bonus:{uranium:3, stone:20, coins:45,    label:" +3 Uranium/min, +20 stone/min & 45 coins/min "},cost:{coins:1500000,stone:100,gold:75}, color:"#4CFC2B", desc:"A nuclear disaster....", special:true},
  {id:"nasa_plant",     name:"N.A.S.A",  country:"usa",      bonus:{spy:2, missile1:7, coins:55, oil:3,   label:" +2 Spy/day, +7 missile/min, 55 coins/min & +3 oil/min "},cost:{coins:3500000,iron:200,gold:135}, color:"#0B3D91", desc:"EXPLORE SPACE!", special:true},
  {id:"generic_flower",     name:"Floralis Genérica",  country:"argentina",      bonus:{spy:1, coins:35, troops:1, gold:1, wood:1, stone:1, iron:1, missile1:1, oil:1,    label:"EVERYTHING!!  +1 spy/day, +35 coins/sec, +1 tank/min, +1 gold/min +1 wood/min +1 stone/min +1 iron/min +1 missile/min +1 oil/min"},cost:{coins:520200,iron:11 ,gold:5}, color:"#D3D3D3", desc:"Generic...  Everything!!", special:true},
];
